    ...
    for (final noteImage in noteImages) {
      ...
      ///
        ...
        if (noteImage.noteLength >= (2 / 4)) {
          ...
          _notePaint.style = PaintingStyle.stroke;
          canvas.drawArc(
              Rect.fromPoints(Offset(0, 0), Offset(w * 3 / 4, h / 4)),
              0,
              math.pi,
              false,
              _notePaint);
          _notePaint.strokeWidth = 1.0;
          canvas.restore();
        } else if (noteImage.noteLength >= (1 / 16)) {
          ///Draw 16th PAUSE
          var pos = naturalPositionOf(NotePosition(note: Note.C, octave: 5));
          var top = bounds.height - (pos * noteHeight);
          ...
          _notePaint.style = PaintingStyle.stroke;
          canvas.drawArc(
              Rect.fromPoints(Offset(w / 2, h * 1 / 3), Offset(0, h / 2)),
              0,
              math.pi,
              false,
              _notePaint);
          _notePaint.strokeWidth = 1.0;
          canvas.restore();
        } else if (noteImage.noteLength >= (1 / 32)) {
          ///Draw 32th PAUSE
          ...
          _notePaint.style = PaintingStyle.stroke;
          canvas.drawArc(
              Rect.fromPoints(Offset(w / 3, h * 3 / 5), Offset(0, h * 4 / 5)),
              0,
              math.pi,
              false,
              _notePaint);
          ...
          _notePaint.strokeWidth = 1.0;
          canvas.restore();
        } else if (noteImage.noteLength >= (1 / 64)) {
          ///Draw 64th PAUSE
          var pos = naturalPositionOf(NotePosition(note: Note.E, octave: 5));
          var top = bounds.height - (pos * noteHeight);
          ...
          _notePaint.style = PaintingStyle.stroke;
          canvas.drawArc(
              Rect.fromPoints(Offset(w / 2, h * 3 / 10), Offset(0, h * 5 / 10)),
              0,
              math.pi,
              false,
              _notePaint);
          ...
          canvas.drawArc(
              Rect.fromPoints(
                  Offset(w / 2, h * 5 / 10), Offset(0, h * 6.6 / 10)),
              0,
              math.pi,
              false,
              _notePaint);
        ...
        if (noteImage.noteLength < 1 / 8) {
          final arcRect = Rect.fromLTWH(
              tailTo.dx - ovalWidth / 2,
              isOnOrAboveMiddleLine
                  ? tailTo.dy - ovalHeight * 3 / 2
                  : tailTo.dy + ovalHeight / 2,
              //bounds.height - (noteIndex * noteHeight) - noteHeight / 2,
              ovalWidth * 3 / 2,
              ovalHeight //tailHeight.toDouble()
              );
        ...
        if (noteImage.noteLength < 1 / 32) {
          final arcRect = Rect.fromLTWH(
              tailTo.dx - ovalWidth / 2,
              isOnOrAboveMiddleLine
                  ? tailTo.dy - ovalHeight * 2.5
                  : tailTo.dy + ovalHeight * 1.5,
              //bounds.height - (noteIndex * noteHeight) - noteHeight / 2,
              ovalWidth * 3 / 2,
              ovalHeight //tailHeight.toDouble()
              );
